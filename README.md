...
### 🚀 最新稳定版 (Latest Sync)
*   **文件名**: `Tapnow Studio-V3.8.0.html`
*   **版本号**: **v3.8.0** (2026-01-17)
*   **主要更新**: 
    *    **智能发送菜单**：历史资产智能识别目标（画布/对话/预览/节点）。
    *    **历史拖拽扩展**：拖拽到节点/分镜/预览，空白画布自动生成输入节点。
    *    **队列可视化**：全局队列面板 + 单项终止/移除。
    *    **批量下载**：全量/选中 ZIP 打包与命名规则。
    *    **历史预览优化**：缩略图重建入口与小图回退修复。
    *    **UI 布局优化**：折叠按钮定位与预览窗口加宽。
